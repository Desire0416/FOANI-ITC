...
/* ==========================================================================
   Pièces communes aux deux espaces authentifiés
   --------------------------------------------------------------------------
   Un seul en-tête de page, une seule tuile, un seul état vide, une seule
   pastille. C'est ce qui fait qu'un écran de scolarité et un écran d'admission
   se ressemblent, et qu'un agent formé sur l'un sait lire l'autre.

   Elles ont d'abord servi le seul back-office. Elles servent désormais aussi
   l'espace du candidat, pour la même raison, à un degré près : le candidat n'a
   personne pour le former. Ce qu'il a appris en remplissant son dossier doit
   valoir encore le jour où il vient chercher son certificat.
   ========================================================================== */
